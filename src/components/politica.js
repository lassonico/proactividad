...
function Politica() {
  return (
    <div className="bg-white p-5 rounded-md h-[450px] overflow-y-scroll scroll-m-2">
        ...
        iii. Base de Datos: Conjunto organizado de Datos Personales que sea objeto de Tratamiento, los cuales pueden ser almacenados y/o procesados en servidores ubicados en centros de cómputo o papelería física, ya sean propios o contratados con terceros, localizados en el territorio nacional o en distintos países. iv. Dato Personal: Cualquier información vinculada o que pueda asociarse a una o varias personas naturales determinadas o determinables.

        v. Dato público: es el dato que no sea semiprivado, privado o sensible. Son considerados datos públicos, entre otros, los datos relativos al estado civil de las personas, a su profesión u oficio y a su calidad de comerciante o de servidor publico. Por su naturaleza, los datos públicos pueden estar contenidos, entre otros, en registros públicos, documentos públicos, gacetas y boletines oficiales y sentencias judiciales debidamente ejecutoriadas que no estén sometidas a reserva.
        ...
        viii. Responsable del Tratamiento: Persona natural o jurídica, pública o privada, que por sí misma o en asocio con otros, decida sobre la base de datos y/o el Tratamiento de los datos. Quien Para efectos de la presente Política, el Responsable será Proactivo Soluciones Financieras.
        ...
        xi. Transmisión: tratamiento de datos personales que implica la comunicación de los mismos dentro o fuera del territorio de la Republica de Colombia cuando tenga por objeto la realización de un tratamiento por el encargado por cuenta de un único responsable.

        xii. Tratamiento: Cualquier operación o conjunto de operaciones sobre Datos Personales, tales como la recolección, almacenamiento, uso, circulación o supresión. Principios.
        ...
        Principio De Veracidad O Calidad: la información sujeta a tratamiento debe ser veráz, completa, exacta, actualizada, comprobable y comprensible. Se prohíbe el tratamiento de datos parciales, incompletos, fraccionados o que induzcan a error.
        ...
        Principio De Seguridad: la información sujeta a tratamiento por Proactivo Soluciones Financieras, se deberá manejar con las medidas técnicas, humanas y administrativas que sean necesarias para otorgar seguridad a los registros evitando su adulteración, pérdida, consulta, uso o acceso no autorizado o fraudulento.
        Principio De Confidencialidad: Proactivo Soluciones Financieras, está obligada a garantizar la reserva de la información, inclusive después de finalizada su relación con alguna de las labores que comprende el tratamiento, pudiendo sólo realizar suministro o comunicación de datos personales cuando ello corresponda al desarrollo de las actividades autorizadas en la ley.
        Autorización para realizar el Tratamiento de los Datos Personales. La recolección almacenamiento, uso, circulación o supresión de datos personales por parte de Proactivo Soluciones Financieras, requiere del consentimiento libre, previo, expreso e informado del titular de los mismos. Proactivo Soluciones Financieras en su condición de responsable del tratamiento de datos personales, ha dispuesto de los mecanismos necesarios para obtener la autorización de los titulares garantizando siempre la posibilidad de verificar el otorgamiento de dicha autorización.
        ...
        Los formatos y textos de autorización será emitida por Proactivo Soluciones Financieras y será puesta a disposición del titular, previo al tratamiento de sus datos personales, de conformidad con lo que establece la Ley 1581 de 2012 y sus decretos reglamentarios.
        ...
        2. La mención de la presente politica de tratamiento de datos personales y su ubicación el la web institucional.

        3. Discriminacion de datos personales que se recopila.

        4. Finalidad de los datos personales que se recopila.

        5. Cómo ejercer derechos de acceso, corrección, actualización o supresión de los datos personales suministrados.

        6. En caso que se recopilen datos sensibles o sobre los datos de las niñas, niños y adolescentes, la indicacion del carácter facultativo de suministrar estos datos. Con el procedimiento de autorización consentida se garantiza que se ha puesto en conocimiento del titular de los datos personales, el hecho que su información personal será recogida y utilizada para fines determinados y conocidos, como que tiene la opción de conocer cualquier alternación a los mismos y el uso específico que de ellos se ha dado.

        Prueba de la autorización: Las áreas responsables del tratamiento de información en Proactivo Soluciones Financieras deben contar con las medidas necesarias para mantener registros de cuándo y cómo se obtuvo autorización por parte de los titulares de datos personales para el tratamiento de los mismos.

        Aviso De Privacidad: El Aviso de Privacidad es el documento físico, electrónico o en cualquier otro formato, que es puesto a disposición del Titular para el tratamiento de sus datos personales, cuando no se pueda poner a disposicion la politica de privacidad. En este documento se comunica al Titular la información relativa a la existencia de las políticas de tratamiento de información que le serán aplicables, la forma de acceder a las mismas y las características del tratamiento que se pretende dar a los datos personales.
        A efectos de garantizar en todos los casos, que la autorización incluye la totalidad de elementos que permiten la titular ejercer en debida forma sus derechos, en el Aviso de Privacidad de Proactivo Soluciones Financieras debe incluir la siguiente información:
        1. Razón social de Proactivo Soluciones Financieras y sus datos de contacto.
        2. El Tratamiento al cual serán sometidos los datos y la finalidad del mismo.
        3. Los derechos que le asisten al titular.
        4. Los mecanismos dispuestos por Proactivo Soluciones Financieras para que el titular conozca la política de Tratamiento de datos.
        5. El carácter facultativo de la respuesta a las preguntas que sean hechas, cuando éstas versen sobre datos sensibles o sobre los datos de las niñas, niños y adolescentes; Datos Sensibles.
        ...
        Proactivo Soluciones Financieras se compromete a proteger la privacidad durante el procesamiento de sus datos personales identificables y sensibles. Por lo tanto, en el evento que de manera expresa los titulares de la información autoricen el uso de datos sensibles, Proactivo Soluciones Financieras se obliga a hacer uso de los mismos de conformidad con las reglas establecidas en sus decretos reglamentarios. Frente a eventos de recolección de datos sensibles siempre se procederá garantizando al menos las siguientes acciones:
        1. Informar al titular que por tratarse de datos sensibles no está obligado a autorizar su Tratamiento.
        2. En caso que Titular y este se encuentre física o jurídicamente incapacitado Se verificará si su tratamiento es necesario para salvaguardar el interés vital del Tituar y si es así se le solicitará a los representantes legales la autorización;
        ...
        3. Solicitar prueba de la autorización otorgada a Proactivo Soluciones Financieras, en su condición de responsable del tratamiento, salvo cuando expresamente se exceptúe está como requisito para el tratamiento (casos en los cuales no es necesaria la autorización).
        4. Ser informado por Proactivo Soluciones Financieras, previa solicitud, respecto del uso que le ha dado a sus datos personales.
        ...
        El Titular de los Datos Personales tendrá el deber de mantener actualizada su información y garantizar, en todo momento, la veracidad de la misma. Proactivo Soluciones Financieras no se hará responsable, en ningún caso, por cualquier tipo de responsabilidad derivada por la inexactitud de la información.

        Deberes de Proactivo Soluciones Financieras

        En virtud de la presente política de tratamiento y protección de datos personales son deberes de Proactivo Soluciones Financieras los siguientes:
        ...
        8. Garantizar que la información sea veráz, completa, exacta, actualizada, comprobable y comprensible.
        ...
        12. Registrar en la base de datos la leyenda <span className="font-bold">reclamo en trámite</span> dentro de los dos días hábiles siguientes a la recepción del reclamo completo.
        ...
        16. Insertar en la base de datos la leyenda <span className="font-bold">información en discusión judicial</span> una vez notificado por parte de la autoridad competente sobre procesos judiciales relacionados con la calidad del dato personal.
        ...
        1. Por el titular, quien deberá acreditar su identidad en forma suficiente por los distintos medios que le ponga a disposición de Proactivo Soluciones Financieras.
        ...
        Todo lo anterior incluye la transferencia de estos datos a terceros países tales como, sin limitar Perú, Ecuador, Bolivia, con fines de almacenamiento y tratamiento.

        Medidas de seguridad para la Protección de los Datos Personales
        Proactivo Soluciones Financieras adoptará las técnicas de seguridad que sean necesarias para otorgar seguridad a los registros evitando su adulteración, pérdida, consulta, uso o acceso no autorizado o fraudulento. Dichas medidas responderán a los requerimientos mínimos hechos por la legislación vigente y periódicamente se evaluará su efectividad. Sin embargo, Proactivo Soluciones Financieras no responderá en caso de presentarse una violación a sus sistemas de seguridad cuando medie fuerza mayor o caso fortuito.
        Área responsable de la atención de peticiones, consultas y reclamos
        Proactivo Soluciones Financieras ha designado como persona responsable de velar por el cumplimiento de esta política al interior de la institución al área de Servicio Al Cliente, quien estará disponible para la atención de peticiones, consultas y reclamos por parte de los titulares y para realizar cualquier actualización, rectificación y supresión de datos personales. Asimismo, el área de Servicio al Cliente o el área jurídica absolverá cualquier duda o inquietud que cualquiera de nuestros funcionarios tenga, a través del correo electrónico que se relaciona en el encabezado de este documento.
        ...
        Para dar cumplimiento a lo anterior Proactivo Soluciones Financieras, Garantizará el derecho de acceso así:
        •El titular podrá conocer la efectiva existencia del tratamiento a que son sometidos sus datos personales.
        •El titular Podrá acceder a sus datos personales que están en posesión de Proactivo Soluciones Financieras.
        •Conocer las finalidades que justifican el tratamiento de sus datos.
        Para el ejercicio del presente derecho Proactivo Soluciones Financieras será necesario la previa acreditación de la identidad del titular o personalidad de su representante, una vez agotado esto se pondrá a disposición de este, de manera gratuita, el detalle de los datos personales a través de medios electrónicos que permitan el acceso directo del Titular a ellos.
        Para consultas cuya periodicidad sea mayor a una por un mes calendario, Proactivo Soluciones Financieras cobrará únicamente los gastos de envío, reproducción, o certificación de documentos.
        Consultas.
        Los titulares o los autorizado según la presente política podrán consultar la información personal del Titular que repose en cualquier base de datos que administre Proactivo Soluciones Financieras
        Para la atención de solicitudes de consulta de datos personales Proactivo Soluciones Financieras garantiza que tiene habilitados los siguientes canales:
        1. El Correo electrónico lasson@proactivosoluciones.com, donde se recibirán las solicitudes las cuales deben contener los documentos necesarios que prueben suficientemente la identidad del titular.
        2. La dirección física calle 17 No 6 - 57 Oficina 401 Edificio ToGo, donde se recibirá las solicitudes las cuales deben ir dirigidas al área de servicio al cliente, en su calidad de responsable de la atención de quejas, consultas y reclamaciones. igualmente, deben contener los documentos necesarios que prueben suficientemente la identidad del titular. Las consultas, serán atendidas en un termino máximo de diez (10) días hábiles contados a partir de la fecha de su recibo. Cuando no fuere posible atender la consulta dentro de dicho termino, se informará al interesado antes del vencimiento de los 10 días, expresando los motivos de la demora y señalando la fecha en que se atenderá su consulta, la cual en ningún caso podrásuperar los cinco (5) días hábiles siguientes al vencimiento del primer plazo. Reclamos.
        Los titulares o los autorizados en la presente política que consideren que la información contenida en una de las bases de datos Proactivo Soluciones Financieras, debe ser objeto de corrección, actualización o supresión, o cuando adviertan el presunto incumplimiento de cualquiera de los deberes contenidos en la Ley 1581 de 2012 o en la presente política, podrán presentar un reclamo ante el Proactivo Soluciones Financieras, el cual será tramitado bajo las siguientes reglas:
        1. El reclamo se podrá presentar directamente en la dirección de correo electrónico lasson@proactivosoluciones.com
        2. La dirección física calle 17 No 6 - 57 oficina 413 edificio ToGo, donde se recibirá los reclamos, los cuales deben ir dirigidas al área de servicio al cliente, en su calidad de responsable de la atención de quejas, consultas y reclamaciones. Los reclamos deben contener los documentos necesarios que prueben suficientemente la identidad del titular, la descripción de los hechos que dan lugar al reclamo, la dirección, y acompañando los documentos que se quiera hacer valer, se requerirá al interesado dentro de los cinco (5) días siguientes a su recepción para que subsane las fallas. Transcurridos dos (2) meses desde la fecha del requerimiento sin que el solicitante presente la información requerida, se entenderá que ha desistido del reclamo. Si por alguna circunstancia Proactivo Soluciones Financieras recibe un reclamo sobre información personal de cuyo tratamiento no es responsable, dará traslado a quien corresponda en un termino máximo de dos (2) días hábiles e informará de la situación al interesado. Una vez recibido el reclamo completo, se incluirá en la base de datos que mantiene Proactivo Soluciones Financieras una leyenda que diga <span className="font-bold">reclamo en tramite</span> y el motivo del mismo, en un termino no mayor a dos (2) días hábiles. Dicha leyenda deberá mantenerse hasta que el reclamo sea decidido. El termino máximo para atender el reclamo será de quince (15) días hábiles contados a partir del día siguiente a la fecha de su recibo. Cuando no fuere posible atenderlo dentro de dicho termino se informará al interesado antes del vencimiento del referido plazo los motivos de la demora y la fecha en que se atenderá su reclamo, la cual en ningún caso podrásuperar los ocho (8) días hábiles siguientes al vencimiento del primer termino.
        Supresión de datos.
        El titular tiene el derecho, en todo momento, a solicitar a Proactivo Soluciones Financieras la supresión (eliminación) de sus datos personales cuando:
        ...
        Esta supresión implica la eliminación de la información personal de acuerdo con lo solicitado por el titular en los registros, bases de datos de Proactivo SOluciones Financieras. Proactivo Soluciones Financieras no procederá con la supresión de la información y la revocatoria de la autorización no procederán cuando el Titular tenga un deber legal o contractual de permanecer en la base de datos. Es importante tener en cuenta que el derecho de cancelación no es absoluto Proactivo Soluciones Financieras puede negar el ejercicio del mismo cuando:
        ...
        3. Los datos sean necesarios para proteger los intereses jurídicamente tutelados del titular; para realizar una acción en función del interés publico, o para cumplir con una obligación legalmente adquirida por el titular. En caso de resultar procedente la cancelación de los datos personales, Proactivo Soluciones Financieras realiza operativamente la supresión de tal manera que la eliminación no permita la recuperación de la información.
        Para el ejercicio del presente derecho se deberá enviar la solicitud detallada al correo electrónico lasson@proactivosoluciones.com o a la dirección física Calle 17 No 6 - 57 Oficina 413 Edificio ToGo, en donde se deberá dirigir la comunicación al área de servicio al cliente.
        Modificación de la Política
        Proactivo Soluciones Financieras podrá modificar o enmendar esta Política de forma discrecional. Cuando se realicen modificaciones o cambios a ésta, se actualizará la fecha de la misma, y esa modificación o enmienda será efectiva a partir de la fecha de actualización. Se recomienda revisar periódicamente esta Política para estar informado acerca de las modificaciones que se puedan presentar.
        Vigencia de la Política
        Esta Política entrará en vigencia a partir de su publicación, esto es cinco de mayo de 2021. Tanto la Política como las Bases de Datos contentivas de la información suministrada podrá permanecer vigente hasta por el término de duración de la sociedad Proactivo Soluciones Financieras sin perjuicio de que esta política pueda ser modificada en cualquier momento y de forma unilateral por parte de Proactivo Soluciones Financieras.</p>
    </div>
  )
}
